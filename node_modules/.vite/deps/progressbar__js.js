...
var require_shifty = __commonJS({
  "node_modules/shifty/dist/shifty.js"(exports, module) {
    !function(t, n) {
      ...
      return function() {
        ...
        var t = { 720: function(t2, n2, e2) {
          ...
          function R(t3, n3, e3, r2, i2, o2) {
            var u2, a2, s2, c2 = 0, f2 = 0, l2 = 0, h2 = function(t4) {
              return ((c2 * t4 + f2) * t4 + l2) * t4;
            }, p2 = function(t4) {
              return (3 * c2 * t4 + 2 * f2) * t4 + l2;
            }, v2 = function(t4) {
              return t4 >= 0 ? t4 : 0 - t4;
            };
            return c2 = 1 - (l2 = 3 * n3) - (f2 = 3 * (r2 - n3) - l2), u2 = 1 - (s2 = 3 * e3) - (a2 = 3 * (i2 - e3) - s2), function(t4) {
              return ((u2 * t4 + a2) * t4 + s2) * t4;
            }(function(t4, n4) {
              var e4, r3, i3, o3, u3, a3;
              for (i3 = t4, a3 = 0; a3 < 8; a3++) {
                if (o3 = h2(i3) - t4, v2(o3) < n4)
                  return i3;
                if (u3 = p2(i3), v2(u3) < 1e-6)
                  break;
                i3 -= o3 / u3;
              }
              if ((i3 = t4) < (e4 = 0))
          ...
          function J(t3, n3) {
            ...
            for (var e3 = 0, r2 = new Array(n3); e3 < n3; e3++)
              r2[e3] = t3[e3];
            return r2;
          }
          function K(t3, n3) {
          ...
          var Z, tt, nt, et = "linear", rt = "undefined" != typeof window ? window : e2.g, it = "afterTween", ot = "afterTweenEnd", ut = "beforeTween", at = "tweenCreated", st = "function", ct = "string", ft = rt.requestAnimationFrame || rt.webkitRequestAnimationFrame || rt.oRequestAnimationFrame || rt.msRequestAnimationFrame || rt.mozCancelRequestAnimationFrame && rt.mozRequestAnimationFrame || setTimeout, lt = function() {
            ...
            for (var h2 in u2 && u2.call && (l2 = true, a2 = u2(f2)), n3)
              l2 || (a2 = ((s2 = u2[h2]).call ? s2 : vt[s2])(f2)), c2 = e3[h2], n3[h2] = c2 + (r2[h2] - c2) * a2;
            return n3;
          }, _t = function(t3, n3) {
            ...
            if (!(n3 < e3 + i2)) {
              ...
              if (t3._hasEnded)
                return t3._render(u2, t3._data, c2), t3.stop(true);
            ...
            for (var t3, n3 = kt.now(), e3 = ht; e3; )
              t3 = e3._next, _t(e3, n3), e3 = t3;
          }, mt = Date.now || function() {
            return +new Date();
          }, gt = false, bt = function(t3) {
            t3 && gt || (gt = t3, t3 && wt());
          }, wt = function t3() {
            Z = mt(), gt && ft.call(rt, t3, 16.666666666666668), dt();
          }, Ot = function(t3) {
          ...
          var kt = function() {
            ...
            return n3 = t3, (e3 = [{ key: "_applyFilter", value: function(t4) {
              ...
              var p2 = n4.from, v2 = n4.to, y2 = void 0 === v2 ? {} : v2, _2 = this._currentState, d2 = this._originalState, m2 = this._targetState;
              for (var g2 in p2)
                _2[g2] = p2[g2];
              var b2 = false;
              for (var w2 in _2) {
                var O2 = _2[w2];
                b2 || G(O2) !== ct || (b2 = true), d2[w2] = O2, m2[w2] = y2.hasOwnProperty(w2) ? y2[w2] : O2;
              }
              if (this._easing = Ot(this._currentState, e4.easing, this._easing), this._filters.length = 0, b2) {
                for (var S2 in t3.filters)
                  t3.filters[S2].doesApply(this) && this._filters.push(t3.filters[S2]);
              ...
              if (this._isPlaying)
                return this._pausedAtTime = t3.now(), this._isPlaying = false, St(this), this;
          ...
          var Mt, At, Et = /(\d|-|\.)/, Tt = /([^\-0-9.]+)/g, It = /[0-9.-]+/g, Ft = (Mt = It.source, At = /,\s*/.source, new RegExp("rgba?\\(".concat(Mt).concat(At).concat(Mt).concat(At).concat(Mt, "(").concat(At).concat(Mt, ")?\\)"), "g")), xt = /^.*\(/, Ct = /#([0-9]|[a-f]){3,6}/gi, Dt = "VAL", qt = function(t3, n3) {
          ...
          var Bt = function(t3) {
            ...
            if (3 === n3.length)
              return "".concat(r2).concat(e3.join(","), ")");
            if (4 === n3.length)
              return "".concat(r2).concat(e3.join(","), ",").concat(n3[3], ")");
            ...
            for (var n3 in t3._currentState)
              if ("string" == typeof t3._currentState[n3])
                return true;
            return false;
          };
          function Gt(t3) {
            ...
            [n3, t3._originalState, t3._targetState].forEach(Rt), t3._tokenData = function(t4) {
              ...
              for (var i2 in t4) {
                var o2 = t4[i2];
                "string" == typeof o2 && (r2[i2] = { formatString: (n4 = o2, e3 = void 0, e3 = n4.match(Tt), e3 ? (1 === e3.length || n4.charAt(0).match(Et)) && e3.unshift("") : e3 = ["", ""], e3.join(Dt)), chunkNames: qt(Ut(o2), i2) });
              }
              return r2;
            }(n3);
          }
          ...
          var Zt = new kt(), tn = kt.filters, nn = function(t3, n3, e3, r2) {
            ...
            for (var a2 in Zt._filters.length = 0, Zt.set({}), Zt._currentState = o2, Zt._originalState = t3, Zt._targetState = n3, Zt._easing = u2, tn)
              tn[a2].doesApply(Zt) && Zt._filters.push(tn[a2]);
          ...
          var an = /* @__PURE__ */ new WeakMap(), sn = function() {
            function t3() {
              ...
              for (var n4 = arguments.length, e4 = new Array(n4), r2 = 0; r2 < n4; r2++)
                e4[r2] = arguments[r2];
        ...
        return e.d = function(t2, n2) {
          for (var r in n2)
            e.o(n2, r) && !e.o(t2, r) && Object.defineProperty(t2, r, { enumerable: true, get: n2[r] });
        }, e.g = function() {
...
var require_utils = __commonJS({
  "node_modules/progressbar.js/src/utils.js"(exports, module) {
...
var require_path = __commonJS({
  "node_modules/progressbar.js/src/path.js"(exports, module) {
...
var require_shape = __commonJS({
  "node_modules/progressbar.js/src/shape.js"(exports, module) {
...
var require_line = __commonJS({
  "node_modules/progressbar.js/src/line.js"(exports, module) {
...
var require_circle = __commonJS({
  "node_modules/progressbar.js/src/circle.js"(exports, module) {
    var Shape = require_shape();
    var utils = require_utils();
...
var require_semicircle = __commonJS({
  "node_modules/progressbar.js/src/semicircle.js"(exports, module) {
    var Shape = require_shape();
...
var require_square = __commonJS({
  "node_modules/progressbar.js/src/square.js"(exports, module) {
    var Shape = require_shape();
    var utils = require_utils();
...
var require_main = __commonJS({
  "node_modules/progressbar.js/src/main.js"(exports, module) {
    module.exports = {
