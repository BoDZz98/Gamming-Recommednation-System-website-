    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mb-10 gap-12">
        @foreach ($userLists as $userList )
            ...
            <a href="{{ route( 'list.index',$userList['list_id'] ) }}" class="group w-52 h-72  transition ease-in-out duration-300">
                <div class="w-52 h-78  rounded-lg bg-gray-800 px-5  ">
                    ...
                    <img src="{{ $userList->list_image_path  }}" alt="game cover" class=" h-60  w-48 hover:opacity-75 transition ease-in-out duration-150 rounded">
