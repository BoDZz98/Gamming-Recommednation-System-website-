            ...
            <div class="flex flex-wrap items-center mt-8 bg-gray-900 rounded-xl p-4">
                ...
                @if (isset($userRating->rating))
                    <div class="flex items-center ml-8">
                        ...
                        <div class="ml-4 text-xs">Matching</div>
                    </div>
                @endif
                <!--  Fav and Wishlist -->
                @if($isFav)
                    <a href="{{ route( 'games.removeGamefromFavorites',$game['id'] ) }}" class="ml-4">
                ...
                @else
                    <a href="{{ route( 'games.addGameToFavorites',$game['id'] ) }}" class="ml-4">
                ...
                @if($isWishList)
                    <a href="{{ route( 'games.removeGamefromWishList',$game['id'] ) }}" >
                ...
                @else
                    <a href="{{ route( 'games.addGameToWishList',$game['id'] ) }}" >
                        {{-- <svg class="svg-icon-2" viewBox="0 0 20 20">
                ...
                <!-- Websites Icons -->
                <div class="flex items-center space-x-4 mt-4  lg:mt-0 lg:ml-8">
