    ...
    <div class="bg-gray-800  rounded-3xl p-8 flex flex-col space-y-8">
        <div class="flex flex-row">
            <div class="recently-reviewed w-full h-fit mr-0 lg:basis-3/4 lg:mr-32 bg-gray-900 rounded-xl p-4 ">
                <span class=" uppercase underline text-xl tracking-wide font-extrabold">Popular</span>
                <span class=" tracking-wide font-extrabold text-xl text-purple-600"> Games</span>
        ...
        <div class="bg-gray-900 rounded-xl p-4 w-full h-fit ">
            <span class=" uppercase underline text-xl tracking-wide font-extrabold">Different</span>
            <span class=" tracking-wide font-extrabold text-xl text-purple-600"> Categories</span>
            @livewire('categories') 
